...
static void mavlink_test_duck_leader_found(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_duck_leader_found_t packet_in = {
		5
    };
	mavlink_duck_leader_found_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.duck_leader_found = packet_in.duck_leader_found;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_found_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_duck_leader_found_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_found_pack(system_id, component_id, &msg , packet1.duck_leader_found );
	mavlink_msg_duck_leader_found_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_found_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.duck_leader_found );
	mavlink_msg_duck_leader_found_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_duck_leader_found_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_found_send(MAVLINK_COMM_1 , packet1.duck_leader_found );
	mavlink_msg_duck_leader_found_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_duck_leader_loc(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_duck_leader_loc_t packet_in = {
		17.0,45.0
    };
	mavlink_duck_leader_loc_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.duck_leader_LR = packet_in.duck_leader_LR;
        	packet1.duck_leader_dist = packet_in.duck_leader_dist;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_loc_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_duck_leader_loc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_loc_pack(system_id, component_id, &msg , packet1.duck_leader_LR , packet1.duck_leader_dist );
	mavlink_msg_duck_leader_loc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_loc_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.duck_leader_LR , packet1.duck_leader_dist );
	mavlink_msg_duck_leader_loc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_duck_leader_loc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_duck_leader_loc_send(MAVLINK_COMM_1 , packet1.duck_leader_LR , packet1.duck_leader_dist );
	mavlink_msg_duck_leader_loc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_duck_leader_found(system_id, component_id, last_msg);
	mavlink_test_duck_leader_loc(system_id, component_id, last_msg);
}
